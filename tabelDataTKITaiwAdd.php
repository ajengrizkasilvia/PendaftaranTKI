            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-2 text-gray-800">PMI Taiwan</h1>
                    </div>
                    <p class="mb-4"><a href="#">Harus!</a> Isi seluruh form dengan berkas-berkas yang sesuai. 
                    Upload berkas dengan format namaPMI_namaBerkas_negaraTujuan.jpg.
                    Tekan <a href="tabelDataTKITaiw.php">BACK</a> untuk kembali ke halaman sebelumnya.</p>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Form Tambah Data TKI Taiwan</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <form method="post" action="tabelDataTKITaiwAddProses.php" enctype="multipart/form-data">
                                    <fieldset>
                                        ...
                                        <div class="form-group">
                                            <label>Sektor</label>
                                            <td>
                                                <input type="text" name="sektor_taiw" class="form-control" required/>
                                            </td>
                                        </div>
                                        <div class="form-group">
                                            <label>E-KTP</label>
