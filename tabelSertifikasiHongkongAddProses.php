...
$query = "INSERT INTO sertifhongkong (id_sertif_hk, id, id_dft, perawatanbayi_hk, pedulianak_hk, pekerjaanrt_hk, perawatanortu_hk, memasak_hk, inggris_hk, kantonis_hk, mandarin_hk, keahlian_hk)
        VALUES('$id_sertif_hk', '$id', '$id_dft', '$perawatanbayi_hk','$pedulianak_hk','$pekerjaanrt_hk','$perawatanortu_hk','$memasak_hk','$inggris_hk', '$kantonis_hk', '$mandarin_hk', '$keahlian_baru')";
