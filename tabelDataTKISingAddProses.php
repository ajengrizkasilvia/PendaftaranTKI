          ...
          if(in_array($ekstensiektp, $ekstensi_diperbolehkanektp) === true)  {     
                  ...
                  // jalankan query INSERT untuk menambah data ke database pastikan sesuai urutan (id tidak perlu karena dibikin otomatis)
                    ...
                    if(!$result){
                      ...
                      echo "<script>alert('Data berhasil ditambah.');window.location='tabelDataTKISing.php';</script>";
                    }
               ...
               //jika file ekstensi tidak jpg dan png maka alert ini yang tampil
                  echo "<script>alert('Ekstensi gambar yang boleh hanya jpg atau png.');window.location='tabelDataTKISingAdd.php';</script>";
              }
            }
  } else {
