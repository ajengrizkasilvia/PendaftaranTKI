    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-2 text-gray-800">Edit Berkas PMI Taiwan</h1>
            </div>
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Form Edit Berkas PMI Taiwan</h6>
                </div>
                <div class="card-body">
                                <?php
                                    include 'config.php';
                                        ...
                                        <form method="post" action="TKIUploadBerkasTaiwanEditProses.php" enctype="multipart/form-data">
                                            <fieldset>
                                                ...
                                                <label class="col-sm-2 col-form-label">Keterangan</label>
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" name="keterangan_taiw" value="<?php echo $d['keterangan_taiw']; ?>" readonly>*diisi oleh admin
                                                    </div>
                                                </div>
                                                <p>
                                                    <td></td>
                                                    <td><button type="submit" class="btn btn-primary btn-lg">Simpan</button></td>
                                                    <td><button type="button" class="btn btn-secondary btn-lg" onclick="javascript:window.location='TKIUploadBerkasTaiwan.php';">Cancel</button></td>
                                                </p>		
                                            </fieldset>
                                        </form>
