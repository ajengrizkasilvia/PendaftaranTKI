...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            Tekan <a href="TKIUploadBerkasMalay.php">BACK</a> untuk kembali ke halaman sebelumnya.</p>

            <!-- DataTales Example -->
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Form Edit Berkas TKI Malaysia</h6>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        ?>
                                <form method="post" action="TKIUploadBerkasMalayEditProses.php" enctype="multipart/form-data">
                                <table>
                                        <tr>			
                                            <td>Nama TKI</td>
                                            <td>
