                    ...
                    <div class="card-body">
                            <form method="post" action="TKIUploadBerkasHongkongAddProses.php" enctype="multipart/form-data">
                                <fieldset>
                                    ...
                                    <div class="form-group">
                                        <label>Ijazah</label>
                                        <td><input type="file" name="ijazah_hk" class="form-control"/></td>
                                        <input type="hidden" name="ijazah_hk_lama">
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <td>Keterangan</td>
                                        <td><input type="text" class="form-control" name="keterangan_hk" readonly>*diisi oleh admin</td>
                                    </div>
                                    <p>
                                        <td></td>
