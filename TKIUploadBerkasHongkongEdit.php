        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Form Edit Berkas PMI Hongkong</h6>
                </div>
                <div class="card-body">
                    <?php
                                    include 'config.php';
                                        ...
                                        <form method="post" action="TKIUploadBerkasHongkongEditProses.php" enctype="multipart/form-data">
                                            <fieldset>
                                                ...
                                                <label class="col-sm-2 col-form-label">Ijazah</label>
                                                    <div class="col-sm-10">
                                                        <img src="berkas/Hongkong/<?php echo $d['ijazah_hk']; ?>" style="width: 120px;float: left;margin-bottom: 5px;">
                                                        <input type="file" name="ijazah_hk"/></td>
                                                        <input type="hidden" name="ijazah_hk_lama" value="<?php echo $d['ijazah_hk']; ?>"/>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        <div class="input-group mb-3">
                                                            <select class="custom-select" id="inputGroupSelect02" name="id_tahapdua">
                                                                <option value='1'>Diajukan</option><option value='1'<?php if($d['id_tahapdua']== '1') echo "selected"?>>Diajukan</option>
                                                            </select>
