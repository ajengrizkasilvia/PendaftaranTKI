            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-2 text-gray-800">Edit Sertifikat Uji Kompetensi PMI Hongkong</h1>
                    </div>
                    <p class="mb-4"><a href="#">Ingat!</a> Cek ulang seluruh isian form dengan benar dan sesuai setelah mengedit.
                    Pastikan berkas sertifikasi yang sesuai dengan format JPG/PNG (nama file: namaPMI_Sertifikasi.jpg).
                                        ...
                                        <form method="post" action="TKISertifikasiHongkongEditProses.php" enctype="multipart/form-data">
                                            <fieldset>
                                                ...
                                                <p>
                                                    ...
                                                    <td><button type="button" class="btn btn-secondary btn-lg" onclick="javascript:window.location='TKISertifikasiHongkong.php';">Cancel</button></td>
                                                </p>
                                            </fieldset>
                                        </form>
                                        <?php 
