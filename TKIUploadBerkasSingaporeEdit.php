...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            Tekan <a href="TKIUploadBerkasSingapore.php">BACK</a> untuk kembali ke halaman sebelumnya.</p>

            <!-- DataTales Example -->
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Form Edit Berkas TKI Singapore</h6>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        ...
                        ?>
                                <form method="post" action="TKIUploadBerkasSingaporeEditProses.php" enctype="multipart/form-data">
                                <table>
                                        <tr>			
                                            <td>Nama TKI</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>Sektor</td>
                                            <td><input type="text" class="form-control" name="sektor_sing" value="<?php echo $d['sektor_sing']; ?>"></td>
                                        </tr>
                                        <tr>
                                            <td>E-KTP</td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>Keterangan</td>
                                            <td><input type="text" class="form-control" name="keterangan_sing" value="<?php echo $d['keterangan_sing']; ?>"></td>
                                        </tr>
                                        <tr>
                                            <td></td>
