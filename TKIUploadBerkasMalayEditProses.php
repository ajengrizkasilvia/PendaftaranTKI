<?php 
    ...
    $query  = "UPDATE malaysia SET id_dft='$id_dft', sektor_malay='$sektor_malay', ektp_malay='$ektp_baru',
     ...
     echo "<script>alert('Data berhasil diubah.');window.location='TKIUploadBerkasMalay.php';</script>";
     }
                                                                    ...
                                                                    if(in_array($ekstensisk, $ekstensi_diperbolehkansk) === true)  {
                                                                        ...
                                                                        if(in_array($ekstensirek, $ekstensi_diperbolehkanrek) === true)  {
                                                                            ...
                                                                            //jika file ekstensi tidak jpg dan png maka alert ini yang tampil
                                                                                echo "<script>alert('Ekstensi gambar yang boleh hanya jpg atau png.');window.location='TKIUploadBerkasMalayEdit.php';</script>";
                                                                                }
