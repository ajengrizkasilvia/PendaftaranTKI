<?php 
	...
	if($ektp_sing != "") {
        ...
        $ektp_baru = $angka_acak.'-'.$ektp_sing;

        if(in_array($ekstensiektp, $ekstensi_diperbolehkanektp) === true)  {     
            move_uploaded_file($file_tmpektp, 'berkas/Singapore/'.$ektp_baru);
        } 
    }else {
        $ektp_baru = $_POST['ektp_sing_lama'];
    }
    $query  = "UPDATE singapore SET id_dft='$id_dft', sektor_sing='$sektor_sing', ektp_sing='$ektp_baru',
        id_tahapdua='$id_tahapdua', keterangan_sing= '$keterangan_sing' 
     ...
     echo "<script>alert('Data berhasil diubah.');window.location='TKIUploadBerkasSingapore.php';</script>";
     }
    ...
    if($kk_sing != "") {
        ...
        $kk_baru = $_POST['kk_sing_lama'];
    }
    $query  = "UPDATE singapore SET id_dft='$id_dft', sektor_sing='$sektor_sing', kk_sing='$kk_baru',
         id_tahapdua='$id_tahapdua', keterangan_sing= '$keterangan_sing' 
        WHERE id_singapore='$id_singapore'";
     $result = mysqli_query($konektor, $query);
     if(!$result){
    ...
    if($akte_sing != "") {
        ...
        $akte_baru = $_POST['akte_sing_lama'];
    }
    $query  = "UPDATE singapore SET id_dft='$id_dft', sektor_sing='$sektor_sing', akte_sing='$akte_baru',
        id_tahapdua='$id_tahapdua', keterangan_sing= '$keterangan_sing' 
        WHERE id_singapore='$id_singapore'";
     $result = mysqli_query($konektor, $query);
     if(!$result){
    ...
    if($suratnikah_sing != "") {
        ...
        $suratnikah_baru = $_POST['suratnikah_sing_lama'];
    }
    $query  = "UPDATE singapore SET id_dft='$id_dft', sektor_sing='$sektor_sing', suratnikah_sing='$suratnikah_baru', 
        id_tahapdua='$id_tahapdua', keterangan_sing= '$keterangan_sing' 
        WHERE id_singapore='$id_singapore'";
     $result = mysqli_query($konektor, $query);
     if(!$result){
    ...
    if($suratijin_sing != "") {
        ...
        $suratijin_baru = $_POST['suratijin_sing_lama'];
    }
    $query  = "UPDATE singapore SET id_dft='$id_dft', sektor_sing='$sektor_sing', suratijin_sing='$suratijin_baru',
         id_tahapdua='$id_tahapdua', keterangan_sing= '$keterangan_sing' 
        WHERE id_singapore='$id_singapore'";
     $result = mysqli_query($konektor, $query);
     if(!$result){
    ...
    if($expaspor_sing != "") {
        ...
        $expaspor = explode('.', $expaspor_sing); //memisahkan nama file dengan ekstensi yang diupload
        ...
        $expaspor_baru = $_POST['expaspor_sing_lama'];
    }
    $query  = "UPDATE singapore SET id_dft='$id_dft', sektor_sing='$sektor_sing', 
        expaspor_sing='$expaspor_baru',  id_tahapdua='$id_tahapdua', keterangan_sing= '$keterangan_sing' 
        WHERE id_singapore='$id_singapore'";
     $result = mysqli_query($konektor, $query);
     if(!$result){
         die ("Query gagal dijalankan: ".mysqli_errno($konektor).
    ...
    if($skck_sing != "") {
        ...
        $skck_baru = $_POST['skck_sing_lama'];
    }
    $query  = "UPDATE singapore SET id_dft='$id_dft', sektor_sing='$sektor_sing',
        skck_sing='$skck_baru', id_tahapdua='$id_tahapdua', keterangan_sing= '$keterangan_sing' 
        WHERE id_singapore='$id_singapore'";
     $result = mysqli_query($konektor, $query);
     if(!$result){
         die ("Query gagal dijalankan: ".mysqli_errno($konektor).
    ...
    if($rekomid_sing != "") {
        ...
        $rekomid_baru = $_POST['rekomid_sing_lama'];
    } 
    $query  = "UPDATE singapore SET id_dft='$id_dft', sektor_sing='$sektor_sing',
        rekomid_sing='$rekomid_baru', id_tahapdua='$id_tahapdua', keterangan_sing= '$keterangan_sing' 
        WHERE id_singapore='$id_singapore'";
     $result = mysqli_query($konektor, $query);
     if(!$result){
         die ("Query gagal dijalankan: ".mysqli_errno($konektor).
    ...
    if($biometri_sing != "") {
        ...
        $biometri_baru = $_POST['biometri_sing_lama'];
    } 
    $query  = "UPDATE singapore SET id_dft='$id_dft', sektor_sing='$sektor_sing',
                                                                    ...
                                                                    if(in_array($ekstensisk, $ekstensi_diperbolehkansk) === true)  {
                                                                        ...
                                                                        if(in_array($ekstensirek, $ekstensi_diperbolehkanrek) === true)  {
                                                                            ...
                                                                            //jika file ekstensi tidak jpg dan png maka alert ini yang tampil
                                                                                echo "<script>alert('Ekstensi gambar yang boleh hanya jpg atau png.');window.location='TKIUploadBerkasSingaporeEdit.php';</script>";
                                                                                }
