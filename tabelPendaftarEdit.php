        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    Pastikan berkas dengan format JPG/PNG (nama_medicalcheck.jpg dan nama_pasfoto.jpg).
                                        ...
                                        <form method="post" action="tabelPendaftarEditProses.php" enctype="multipart/form-data">
                                            <fieldset>
                                                ...
                                                <p>
                                                    ...
                                                    <td><button type="button" class="btn btn-secondary btn-lg" onclick="javascript:window.location='tabelPendaftar.php';">Cancel</button></td>
                                                </p>		
                                            </fieldset>
                                        </form>
                                        <?php 
