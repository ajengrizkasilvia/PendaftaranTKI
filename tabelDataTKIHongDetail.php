            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-2 text-gray-800">View Detail Data PMI Hongkong</h1>
                    ...
                    <div>    
                        <ul class="breadcrumb">
                            ...
                            <li><a href="tabelDataTKIHong.php">Data PMI Hongkong</a> <span class="divider">/</span></li>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Detail PMI Hongkong</h6>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="tabelDataTKIHongCetakIjasah.php?id_hongkong=<?php echo $d['id_hongkong']; ?>" class="d-none d-sm-inline-block btn btn-sm btn-secondary shadow-sm">
                                                <i class="fas fa-download fa-sm text-white-50"></i>Download</a>                                                  
                                            </td>
                                        </tr>
                                        <tr>
