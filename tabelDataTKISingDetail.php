                                ...
                                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        ...
                                        <tr>
                                            <td>Sektor</td>
                                            <td>
                                                <?php echo $d['sektor_sing']; ?>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>E-KTP</td>
                                            <td>
                                                <img src="berkas/Singapore/<?php echo $d['ektp_sing']; ?>" style="width: 800px;float: left;margin-bottom: 5px;">                                                   
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Kartu Keluarga</td>
                                            <td>
                                                <img src="berkas/Singapore/<?php echo $d['kk_sing']; ?>" style="width: 800px;float: left;margin-bottom: 5px;">                                                    
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Akta Kelahiran</td>
                                            <td>
                                                <img src="berkas/Singapore/<?php echo $d['akte_sing']; ?>" style="width: 800px;float: left;margin-bottom: 5px;">                                                    
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Surat Menikah</td>
                                            <td>
                                                <img src="berkas/Singapore/<?php echo $d['suratnikah_sing']; ?>" style="width: 800px;float: left;margin-bottom: 5px;">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Surat Ijin Ortu/Suami</td>
                                            <td>
                                                <img src="berkas/Singapore/<?php echo $d['suratijin_sing']; ?>" style="width: 800px;float: left;margin-bottom: 5px;">                                                   
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Ex Paspor</td>
                                            <td>
                                                <img src="berkas/Singapore/<?php echo $d['expaspor_sing']; ?>" style="width: 800px;float: left;margin-bottom: 5px;">        
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>SKCK</td>
                                            <td>
                                                <img src="berkas/Singapore/<?php echo $d['skck_sing']; ?>" style="width: 800px;float: left;margin-bottom: 5px;">        
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Rekom Id</td>
                                            <td>
                                                <img src="berkas/Singapore/<?php echo $d['rekomid_sing']; ?>" style="width: 800px;float: left;margin-bottom: 5px;">                                                    
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Biometri</td>
                                            <td>
                                                <img src="berkas/Singapore/<?php echo $d['biometri_sing']; ?>" style="width: 800px;float: left;margin-bottom: 5px;">
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>Status Proses</td>
